...
**Leaderboard** is a project based on working with APIs. It can be used to create a new and add scores and then display it in the webpage.
...
- Deeper understanding of promises together with the use of APIs

<p align="right">(<a href="#readme-top">back to top</a>)</p>

## 🚀 Live Demo <a name="live-demo"></a>

- [<a href="https://anbehindy.github.io/Leaderboard/dist" target="_blank">Live version</a>](#)
...
Contributions, issues, and feature requests are welcome!
 ...
 - https://github.com/anbehindY/Leaderboard/issues
